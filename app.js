...
const RECAP = [
  { title: "Главный апгрейд", pill: "характер", text: "Ты прошёл год и не сдался. Это сильнее любой мотивации." },
  { title: "Чему научился", pill: "скиллы", text: "Больше дисциплины, больше ответственности, меньше лишнего шума." },
  { title: "Что забираем в 2026", pill: "план", text: "Делай меньше, но лучше. Сфокусируйся на 1–2 целях и разнеси." },
  { title: "Что оставляем в 2025", pill: "минус", text: "Самоедство, перегруз, сомнения в себе. Ты уже достаточно хорош, чтобы идти." },
];

const WISHES = [
  "Пусть у тебя будет энергия делать важное, и спокойствие отпускать лишнее.",
  "Пусть деньги приходят честно, люди — тёплые, а голова — ясная.",
  "Пусть в 2026 ты станешь той версией себя, которой сам гордишься.",
  "Пусть рядом будут люди, которые усиливают тебя, а не забирают силы.",
];
